...
data {
  ...
  array[N_trend, N_series_trend] int times_trend;
    int nb_1_trend;  // number of bases
    matrix[N_trend, knots_1_trend[1]] Zs_1_1_trend;
    array[nb_1_trend] int knots_1_trend;  // number of knots
    int Ks_trend;  // number of linear effects
    matrix[N_trend, Ks_trend] Xs_trend;  // design matrix for the linear effects
...
vector[knots_1_trend[1]] zs_1_1_trend;
vector<lower=0>[nb_1_trend] sds_1_trend;  // SDs of penalized spline coefficients
...
transformed parameters {
  ...
  real Intercept_trend;  // temporary intercept for centered predictors
  vector[Ks_trend] bs_trend;  // unpenalized spline coefficients
  vector[knots_1_trend[1]] s_1_1_trend;
  vector[N_trend] mu_trend = rep_vector(0.0, N_trend);
  mu_trend += Intercept_trend + Xs_trend * bs_trend + Zs_1_1_trend * s_1_1_trend;
  ...
  vector[knots_1_trend[1]] s_1_1_trend;
s_1_1_trend = sds_1_trend[1] * zs_1_1_trend;
lprior += student_t_lpdf(Intercept_trend | 3, 0.2, 2.5);
lprior += student_t_lpdf(sds_1_trend | 3, 0, 2.5)
