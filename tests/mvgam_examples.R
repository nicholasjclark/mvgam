...
mvgam_examp_dat <- list(
  data_train =
    structure(list(y = c(-1.6435760529886, 0.0576506632876403,
                         -0.398982741359959, 0.166263635072232, NA, -0.178792865387502,
                         0.0378992006898741, -0.46704324582468, -0.20005752901963, NA,
                         -0.7648331324566, -1.95818875683478, -0.489141832766607, NA,
                         -0.781926449502298, -0.173065622618926, NA, -0.431888938737423,
                         -1.33563987611521, -0.30668079493666, -1.59343527302515, -2.08089938293457
    ),
    season = c(1L, 1L, 2L, 2L, 3L, 3L, 4L, 4L, 5L, 5L, 6L, 6L,
               7L, 7L, 8L, 8L, 9L, 9L, 10L, 10L, 11L, 11L),
    year = c(1L, 1L,
             1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L,
             1L, 1L, 1L, 1L),
    series = structure(c(1L, 2L, 1L, 2L, 1L, 2L,
    ...
    class = "data.frame", row.names = c(NA,
                                        -22L)),
  data_test = structure(list(
    y = c(-0.825903793273796,
          NA, -0.409364591883054, -0.801934825421605, NA, 0.993612304219531,
          0.465708559827663, -0.268653159692507),
    season = c(12L, 12L,
               1L, 1L, 2L, 2L, 3L, 3L),
    year = c(1L, 1L, 2L, 2L, 2L, 2L, 2L,
             2L),
    series = structure(c(1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L),
                       levels = c("series_1",
                                  "series_2"), class = "factor"),
    time = c(12L, 12L, 13L, 13L,
             14L, 14L, 15L, 15L)),
    class = "data.frame",
    row.names = c(NA,
                  -8L)))
...
mvgam_example1 <- mvgam(y ~ s(season, k = 4),
                        trend_model = RW(),
                        family = gaussian(),
...
mvgam_example3 <- mvgam(y ~ s(season, k = 4),
...
mvgam_example4 <- mvgam(y ~ series + s(season, k = 4),
                        trend_model = GP(),
                        family = gaussian(),
                        use_lv = TRUE,
                        n_lv = 2,
