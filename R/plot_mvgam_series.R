...
# Check variables in newdata / data_test
  ...
  if(series == 'all'){
    ...
    plot_hist <- dat |>
      ...
      ggplot2::geom_histogram(bins = n_bins, fill = "#C79999") +
    ...
    # plot
    patchwork::wrap_plots(plot_ts, plot_hist, plot_acf, plot_ecdf, ncol = 2, nrow = 2, byrow = T)
  }
}
