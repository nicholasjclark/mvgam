...
- **extract_trend_stanvars_from_setup()** (`R/stan_assembly.R`)
  - Internal calls: combine_stanvars, extract_and_rename_trend_parameters, extract_time_series_dimensions, generate_obs_trend_mapping, generate_trend_specific_stanvars
- **assemble_mvgam_stan_data()** (`R/stan_assembly.R`)
  - Internal calls: generate_base_brms_standata, validate_stan_data_structure
...
- **extract_trend_stanvars_from_setup()** (`R/stan_assembly.R`) - 5 dependencies
  - Calls: combine_stanvars, extract_and_rename_trend_parameters, extract_time_series_dimensions, generate_obs_trend_mapping, generate_trend_specific_stanvars
