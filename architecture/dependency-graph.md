...
- **auto_register_trend_types()** (`R/trend_system.R`)
  - Internal calls: register_trend_type, validate_trend_properties
...
- **insert_into_stan_block()** (`R/stan_assembly.R`)
  - Internal calls: detect_glm_usage, extract_and_rename_stan_blocks, extract_mapping_arrays, find_stan_block, generate_obs_trend_mapping, generate_trend_injection_code, inject_trend_into_glm_predictor, inject_trend_into_linear_predictor, insert_after_mu_lines_in_model_block, validate_mapping_arrays
...
- **register_core_trends()** (`R/trend_system.R`)
  - Internal calls: auto_register_trend_types
...
- **insert_into_stan_block()** (`R/stan_assembly.R`) - 10 dependencies
  - Calls: detect_glm_usage, extract_and_rename_stan_blocks, extract_mapping_arrays, find_stan_block, generate_obs_trend_mapping, generate_trend_injection_code, inject_trend_into_glm_predictor, inject_trend_into_linear_predictor, insert_after_mu_lines_in_model_block, validate_mapping_arrays
