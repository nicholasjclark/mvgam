...
- **`R/stan_assembly.R`** (84 functions) - Stan model integration
  - Key functions: apply_response_suffix_to_stanvars, apply_suffix_to_stan_code, generate_combined_stancode, detect_shared_trends, generate_base_stancode_with_stanvars, prepare_mvgam_stancode, prepare_stan_data, prepare_stanvars_for_brms, extract_trend_stanvars_from_setup, inject_trend_into_glm_predictor, find_trend_computation_end, validate_mapping_arrays, find_stan_block, insert_into_stan_block, inject_trend_into_linear_predictor (+ 69 more)
