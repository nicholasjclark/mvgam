...
- **generate_combined_stancode()** (`R/stan_assembly.R`) - 10 dependencies
  - Calls: assemble_mvgam_stan_data, extract_response_names, extract_trend_stanvars_from_setup, generate_base_brms_standata, generate_base_stancode_with_stanvars, inject_multivariate_trends_into_linear_predictors, inject_trend_into_linear_predictor, is_multivariate_trend_specs, sort_stanvars, validate_stan_code
...
### Stan/Modeling Files
- **`R/stan_assembly.R`** (77 functions) - Stan model integration
