...
- **extract_code_block()** (`R/stan_assembly.R`) - 72 dependencies
...
- **inject_trend_into_glm_predictor()** (`R/stan_assembly.R`) - 67 dependencies
...
- **insert_into_stan_block()** (`R/stan_assembly.R`) - 66 dependencies
...
- **find_stan_block()** (`R/stan_assembly.R`) - 65 dependencies
...
- **`R/print.mvgam.R`** (6 functions) - Print methods for objects
  - Key functions: print.mvgam, stancode.mvgam, stancode.mvgam_prefit, print.mvgamstancode, print_model_specification_simple, print.mvgam_prefit
