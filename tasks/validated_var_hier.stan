...
parameters {
  ...
  array[N_groups_trend, 1] matrix[N_subgroups_trend, N_subgroups_trend] A_raw_group_trend;
...
transformed parameters {
  ...
  array[1] matrix[N_lv_trend, N_lv_trend] empty_theta;
  empty_theta[1] = rep_matrix(0.0, N_lv_trend, N_lv_trend);
  Omega_trend = initial_joint_var(Sigma_trend, A_trend, empty_theta[1 : 0]);
