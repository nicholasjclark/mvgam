...
portal_dat <- read.csv('https://raw.githubusercontent.com/nicholasjclark/mvgam/
                       master/manuscript_analysis/Case studies/rodents_data.csv', as.is = T)
```
...
library(mvgam)
library(dplyr)
portal_dat <- read.csv('https://raw.githubusercontent.com/nicholasjclark/mvgam/master/manuscript_analysis/Case studies/rodents_data.csv', as.is = T)
```
