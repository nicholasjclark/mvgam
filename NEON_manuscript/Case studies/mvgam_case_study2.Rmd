...
ppc(trends_mod3, series = 1, type = 'density')
```

```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(trends_mod3, series = 2, type = 'density')
```

```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(trends_mod3, series = 3, type = 'density')
```

```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(trends_mod3, series = 4, type = 'density')
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(trends_mod3, series = 1, type = 'density', data_test = trends_data$data_test)
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(trends_mod3, series = 2, type = 'density', data_test = trends_data$data_test)
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(trends_mod3, series = 3, type = 'density', data_test = trends_data$data_test)
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(trends_mod3, series = 4, type = 'density', data_test = trends_data$data_test)
```
