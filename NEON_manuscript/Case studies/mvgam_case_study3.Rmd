...
As with all other `mvgam` objects, we can create plots of the estimated forecast distribution and the dynamic latent trend process
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
...
Traceplots of smooth penalties and latent trend parameters indicate good mixing and convergence of the four MCMC chains
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
plot_mvgam_trace(test, 'rho')
