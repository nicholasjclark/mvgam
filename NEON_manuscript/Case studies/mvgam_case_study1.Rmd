...
mod2 <- mvjagam(data_train = fake_data$data_train,
               ...
               formula = y ~ s(season, bs = c('cc'), k = 12) +
                 s(year, bs = "bs", m = c(3, 2, 1, 0)) +
                  ti(season, year, bs = c('cc', 'tp'), k = c(12, 3), m = c(2, 1)),
               knots = list(season = c(0.5, 12.5),
