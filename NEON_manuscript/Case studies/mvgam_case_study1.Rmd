...
Inspecting the model's smooth function for the fake covariate `fake_cov` shows that the function is essentially flat and there is no structure left in the expected partial residuals. Together this evidence indicates that the function is unimportant
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
