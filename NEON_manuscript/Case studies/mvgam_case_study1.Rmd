...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
plot_mvgam_smooth(mod1, series = 1, smooth = 'year', residuals = TRUE)
```

Perform a series of posterior predictive checks (using the `ppc()` function) to see if the model is able to simulate data for the training period that looks realistic and unbiased. First, examine simulated histograms for posterior predictions (`yhat`) and compare to the observations (`y`)
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(mod1, series = 1, type = 'hist', legend_position = 'bottomright')
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
plot(mod1, series = 1, type = 'forecast', data_test = fake_data$data_test)
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(mod1, series = 1, type = 'hist', data_test = fake_data$data_test,
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
plot(mod2, series = 1, type = 'forecast', data_test = fake_data$data_test)
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(mod2, series = 1, type = 'hist', data_test = fake_data$data_test)
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
plot(mod3, series = 1, type = 'forecast', data_test = fake_data$data_test)
```

```{r, fig.width = 5, fig.height = 4, fig.align='center'}
ppc(mod3, series = 1, type = 'hist', data_test = fake_data$data_test)
```
...
```{r, fig.width = 5, fig.height = 4, fig.align='center'}
plot(mod4, series = 1, type = 'forecast', data_test = fake_data$data_test)
```
