...
And we can plot the nonlinear effects as before:
```{r}
...
plot(diff_scores, pch = 16, cex = 1.25, col = 'darkred', 
     ...
     ylab = expression(energy[GP]~-~energy[spline]))
...
The GP model does better, and the difference between scores grows quickly as the forecast horizon increases. This is not unexpected given the way that splines linearly extrapolate outside the range of training data
