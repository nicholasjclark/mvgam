...
# with productivitity; we will add in a fairly strong AR1 process to 
...
mod <- mvgam(formula =
            ...
            priors = c(prior(normal(2, 1), class = sigma),
...
We can get more useful plots of these effects using the `plot_predictions` function from the `marginaleffects` package, which will plot effects on the scale of the observations for a more meaningful interpretation:
```{r}
