...
Note that if you already know the names of parameters for which you'd like to modify the priors, you can more quickly make edits using `brms` functionality:
```{r eval=FALSE}
