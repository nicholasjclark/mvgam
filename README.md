...
can suppress a summary of the spline *β* coefficients, which is useful
when there are many coefficients to report:
    ...
    #>         2.5%     50% 97.5% Rhat n_eff
    #> A[1,1]  0.69  0.9000 1.100 1.00   614
    #> A[1,2] -0.26 -0.0150 0.250 1.01   708
    #> A[1,3] -0.09  0.0077 0.120 1.00  1111
    #> A[1,4] -0.10 -0.0092 0.074 1.00   781
    #> A[2,1] -0.30  0.0460 0.490 1.01   434
    #> A[2,2]  0.43  0.8300 1.100 1.00   567
    #> A[2,3] -0.22 -0.0240 0.130 1.00   845
    #> A[2,4] -0.19 -0.0081 0.170 1.02   350
    #> A[3,1] -1.20 -0.0990 1.300 1.07    85
    #> A[3,2] -1.50 -0.1100 1.300 1.10    76
    #> A[3,3]  0.12  0.7100 1.200 1.08   103
    #> A[3,4] -0.11  0.2200 0.860 1.05   145
    #> A[4,1] -2.00 -0.2000 2.100 1.08    71
    #> A[4,2] -2.70 -0.3000 2.700 1.15    49
    #> A[4,3] -1.20 -0.2900 0.670 1.10    69
    #> A[4,4]  0.56  0.9700 1.700 1.07   106
    #> 
    #> Process error parameter estimates:
    #>               2.5%     50% 97.5% Rhat n_eff
    #> Sigma[1,1]  0.0075  0.0230 0.061 1.02   286
    #> Sigma[1,2] -0.0089  0.0100 0.050 1.02   351
    #> Sigma[1,3] -0.0660 -0.0120 0.032 1.01   332
    #> Sigma[1,4] -0.0590 -0.0088 0.036 1.00   985
    #> Sigma[2,1] -0.0089  0.0100 0.050 1.02   351
    #> Sigma[2,2]  0.0075  0.0460 0.240 1.04    91
    #> Sigma[2,3] -0.1400 -0.0310 0.039 1.01   543
    #> Sigma[2,4] -0.0970 -0.0015 0.087 1.01   733
    #> Sigma[3,1] -0.0660 -0.0120 0.032 1.01   332
    #> Sigma[3,2] -0.1400 -0.0310 0.039 1.01   543
    #> Sigma[3,3]  0.0720  0.2500 0.760 1.04   158
    #> Sigma[3,4]  0.0059  0.1400 0.430 1.01   410
    #> Sigma[4,1] -0.0590 -0.0088 0.036 1.00   985
    #> Sigma[4,2] -0.0970 -0.0015 0.087 1.01   733
    #> Sigma[4,3]  0.0059  0.1400 0.430 1.01   410
    #> Sigma[4,4]  0.1200  0.3300 0.890 1.02   227
    #> 
    #> GAM process model coefficient (beta) estimates:
    #>                    2.5%   50% 97.5% Rhat n_eff
    #> trendtrend1_trend  2.50  2.90  3.20 1.01   941
    #> trendtrend2_trend -0.21  0.46  1.00 1.01   498
    #> trendtrend3_trend -1.20 -0.10  0.83 1.01   757
    #> trendtrend4_trend -0.21  0.71  1.60 1.00   897
    #> 
    #> GAM process model group-level estimates:
    #>                                  2.5%  50% 97.5% Rhat n_eff
    #> mean(s(trend):ndvi_ma12)_trend -0.500 0.37   1.2    1  1175
    #> sd(s(trend):ndvi_ma12)_trend    0.013 0.40   2.2    1   870
    #> 
    #> Approximate significance of GAM process smooths:
    #>                          edf Ref.df Chi.sq p-value
    #> s(mintemp):seriestrend1 1.52      9   1.68    0.35
    #> s(mintemp):seriestrend2 1.48      9   0.10    0.92
    #> s(mintemp):seriestrend3 2.39      9   3.67    0.21
    #> s(mintemp):seriestrend4 1.43      9   0.53    0.57
    #> s(series):ndvi_ma12     2.50      4   1.23    0.67
    #> 
    ...
    #> Chain 1: E-FMI = 0.1733
    #> Chain 2: E-FMI = 0.1958
    #> Chain 3: E-FMI = 0.1893
    #> Chain 4: E-FMI = 0.1485
    #>  *E-FMI below 0.2 indicates you may need to reparameterize your model
    #> 
    #> Samples were drawn using NUTS(diag_e) at Wed Mar 05 03:26:59 2025.
...
estimates for the `Beta` precision parameters *ϕ*.
    ...
    #> 
    #> Samples were drawn using NUTS(diag_e) at Wed Mar 05 03:28:03 2025.
    #> For each parameter, n_eff is a crude measure of effective sample size,
    #> and Rhat is the potential scale reduction factor on split MCMC chains
    #> (at convergence, Rhat = 1)
    #> 
